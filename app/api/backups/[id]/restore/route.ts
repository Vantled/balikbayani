      ...
      try {
        ...
        if (isSimpleBackup && !isPgDumpFormat) {
          ...
          try {
              ...
              for (const statement of statements) {
                if (statement.trim()) {
                  try {
                    ...
                    console.error(`[BACKUPS RESTORE ID] Error executing statement:`, stmtError.message)
                    throw stmtError
                  }
                }
              }
            ...
            console.error('[BACKUPS RESTORE ID] Database restore via connection failed:', dbError)
