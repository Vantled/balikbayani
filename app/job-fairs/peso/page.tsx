...
export default function PesoContactsPage() {
  ...
  const filteredContacts = pesoContacts.filter(contact =>
    ...
    <div className="min-h-screen bg-[#eaf3fc] flex flex-col">
      ...
      <main className="p-6 pt-24">
        <div>
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-medium text-[#1976D2]">PESO Contacts</h2>
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredContacts.map((contact, i) => (
                    <tr key={i} className="hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-center">{contact.pesoOffice}</td>
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent className="max-w-md">
          <DialogTitle>Create PESO Contact</DialogTitle>
          <form onSubmit={handleModalSubmit} className="space-y-4 mt-2">
            <input name="province" type="text" required className="w-full border rounded px-3 py-2" placeholder="Province" onChange={handleModalChange} />
            <input name="pesoOffice" type="text" required className="w-full border rounded px-3 py-2" placeholder="PESO Office" onChange={handleModalChange} />
