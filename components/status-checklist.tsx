  ...
  return (
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
                      ...
                      return (
                        <div 
                          ...
                          className={`flex items-center space-x-3 p-2 rounded-md cursor-pointer transition-colors ${
                            isCurrentlySelected ? 'bg-blue-50 border border-blue-200' : 
                            isPreviouslyChecked ? 'cursor-not-allowed opacity-70' : 'hover:bg-gray-50'
                          }`}
                        ...
                        >
                          ...
                          <label
                            className={`text-sm font-medium leading-none flex items-center gap-2 ${
                              isPreviouslyChecked ? 'cursor-not-allowed' : 'cursor-pointer'
                            }`}
                          >
                            {option.label}
                          </label>
      ...
      <Dialog open={showWarningModal} onOpenChange={setShowWarningModal}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-red-600">Confirm Status Changes</DialogTitle>
          </DialogHeader>
