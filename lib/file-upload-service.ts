...
export class FileUploadService {
	...
	private static validateFile(file: File): { valid: boolean; error?: string } {
		...
		if (!this.allowedMimeTypes.includes(file.type)) {
			return { valid: false, error: 'File type not allowed. Only JPEG, PNG, PDF, and DOCX files are accepted' };
		}
	...
	// Upload file from a browser File object
	...
	// Upload server-generated Buffer
