...
async function initializeDatabase() {
  try {
    ...
    const migrations = [
      ...
      { file: 'migrations/add_document_meta.sql', desc: 'Adding meta JSONB column to documents table' },
      { file: 'migrations/migrate-direct-hire-documents.sql', desc: 'Creating direct_hire_documents table and adding fields to direct_hire_applications' },
      { file: 'migrations/20251006_bm_add_salary_columns.sql', desc: 'Adding raw_salary and salary_currency columns to BM clearance' },
      { file: 'migrations/20251006_bm_clearance_type_nullable.sql', desc: 'Making clearance_type nullable for BM clearance' },
      { file: 'migrations/20251028_add_deleted_at_information_sheet.sql', desc: 'Adding deleted_at to information_sheet_records' },
      { file: 'migrations/20251028_add_g2g_experience_fields.sql', desc: 'Adding Taiwan and other experience fields to Gov-to-Gov applications' },
      ...
      { file: 'migrations/20250108_add_name_columns_to_users.sql', desc: 'Adding first_name, middle_name, and last_name columns to users table' },
      ...
      { file: 'migrations/20250305_add_gov_to_gov_corrections.sql', desc: 'Adding corrections workflow for Gov-to-Gov applications' },
